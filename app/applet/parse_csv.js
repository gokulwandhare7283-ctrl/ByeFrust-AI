...
const csvPath = path.join(__dirname, 'byefrust_ai', 'products.csv');
...
for (let i = 1; i < lines.length; i++) {
  // Handle commas inside quotes if any, but looking at the CSV, it seems simple enough.
  // Wait, use_case_tags has commas inside quotes: "work,study,casual"
  // Let's use a proper regex for splitting CSV
  const line = lines[i];
